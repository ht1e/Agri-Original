            ...
            <ul class="w-full float-right">
                <li class="inline mx-2 ">
                    ...
                    <a href="{{route('getProfile')}}" class=" text-[10px] group">
                        <span class=" text-[#37903B] opacity-45 group-hover:opacity-100">{{Auth::user()->ND_Ten}}</span>
                        <i class="fa-solid fa-user py-2 text-xl text-[#37903B] opacity-45 group-hover:opacity-100"></i>
                    </a>
                    @else
                    <a href="{{route('login')}}" class=" text-[10px] group">
                        <span class="text-[#37903B] opacity-45 group-hover:opacity-100">Đăng nhập</span>
                        <i class="fa-solid fa-user py-2 text-xl text-[#37903B] opacity-45 group-hover:opacity-100"></i>
                    </a>
                    @endif
                </li>
